...
Scenario: Hacer login, crear nueva pagina, ir al listado de paginas, seleccionarla y eliminarla.
  ...
  And I save screenshot v444 "3" "1"
  ...
  And I save screenshot v444 "3" "2"
  And I click pages
  And I wait for 2 seconds
  And I save screenshot v444 "3" "3"
  And I click new page
  And I wait for 2 seconds
  And I save screenshot v444 "3" "4"
  ...
  And I wait for 1 seconds
  And I save screenshot v444 "3" "5"
  And I click publish
  And I wait for 3 seconds
  And I save screenshot v444 "3" "6"
  And I click pages from page
  And I wait for 2 seconds
  And I save screenshot v444 "3" "7"
  And I select page by title
  And I wait for 2 seconds
  And I select page settings
  And I wait for 2 seconds
  And I save screenshot v444 "3" "8"
  And I select delete page
  And I wait for 2 seconds
  And I save screenshot v444 "3" "9"
  And I select delete confirm
  And I wait for 1 seconds
  And I save screenshot v444 "3" "10"
