Feature: Login, list post, and delete post 
        ...
        Scenario: Ingresar con cuenta válida, Listar Posts, Delete Post, Listar Posts
                ...
                And I save screenshot v435 "5" "1"
                ...
                And I save screenshot v435 "5" "2"
                And I enter new post title "Nuevo post"
                And I wait for 2 seconds
                And I enter new post body "body text post"
                And I wait for 2 seconds
                And I save screenshot v435 "5" "3"
                Then I navigate to page "<LISTPOSTPAGE43>"
                And I wait for 2 seconds
                And I save screenshot v435 "5" "4"
                And I click firts post 
                And I wait for 2 seconds
                And I save screenshot v435 "5" "5"
                And I click settings post
                And I wait for 2 seconds
                And I save screenshot v435 "5" "6"
                And I click delete post
                And I wait for 2 seconds
                And I save screenshot v435 "5" "7"
                And I click confirm delete post
                And I wait for 3 seconds
                And I save screenshot v435 "5" "8"
                Then I navigate to page "<LISTPOSTPAGE43>"
                And I save screenshot v435 "5" "9"
                And I wait for 3 seconds
