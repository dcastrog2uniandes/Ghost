...
describe('Crear miembro con nombre muy largo', () => {
    beforeEach(()=>{
       cy.visit(urlProbar)
        cy.wait(1000)
    ...
    it('Crear miembro con nombre muy largo', ()=>{
        //loguease
        ...
        cy.wait(500)
        cy.get('form').within(() => {
            cy.get('#member-name').type(userData.cadenaLarga,{force: true})
        ...
        cy.get('button[type=button]').contains('Retry')  
