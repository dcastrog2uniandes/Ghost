...
## Reporte de Issues
Se evidenciaron 4 issues con las pruebas de regresión y para ver sus detalles vaya a la sección [issues](https://github.com/dcastrog2uniandes/Ghost/issues)
