...
let userData = {
  ...
  cadenaLarga: faker.lorem.paragraph()
}
...
describe('Crear miembro con label muy largo', () => {
    beforeEach(()=>{
       cy.visit(urlProbar)
        cy.wait(1000)
    ...
    it('Crear miembro con label muy largo', ()=>{
        //loguease
        ...
        cy.get('form').within(() => {
            ...
            cy.get('.ember-power-select-trigger-multiple-input').type(userData.cadenaLarga,{force: true})
