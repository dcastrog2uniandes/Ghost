...
describe('Testing Ghost create new page', () => {
    beforeEach(()=>{
    ...
    it('Escenario 1 create new page', ()=>{
        //Login
        cy.get('form').within(() => {
        ...
        cy.get('div.gh-editor-feature-image > img').first().trigger('mouseover')
        cy.wait(300)
        
        cy.contains('image-delete').first().click()
        cy.wait(300)
