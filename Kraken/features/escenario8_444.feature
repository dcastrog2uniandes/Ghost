Feature: Login, list post, and edit post 
        ...
        Scenario: Ingresar con cuenta válida, Listar Posts, Editar Post, Listar Posts
                ...
                And I save screenshot v444 "6" "1"
                ...
                Then I navigate to page "<LISTPOSTPAGE44>"
                And I wait for 2 seconds
                And I save screenshot v444 "6" "6"
                Then I navigate to page "<NEWPOSTPAGE44>"
                ...
                Then I navigate to page "<LISTPOSTPAGE44>"
                And I wait for 3 seconds
                And I save screenshot v444 "6" "7"
                And I click firts post to edit
                And I wait for 3 seconds
                And I save screenshot v444 "6" "8"
                And I enter new post title "Post Three"
                And I wait for 2 seconds
                Then I navigate to page "<LISTPOSTPAGE44>"
                And I save screenshot v444 "6" "9"
